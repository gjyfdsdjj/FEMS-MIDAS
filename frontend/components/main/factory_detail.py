...
def factory_detail(
    ...
    with dh2:
        st.markdown(
            ...
            f'<span class="badge" style="background:{sb};color:{sc};font-size:13px;padding:5px 14px">'
            f'{st_txt}</span></div>',
            unsafe_allow_html=True
        )
    ...
    for col, label, val, unit, sub, clr, spark in [
        ...
        with col:
            ...
            <div class="metric-box">
                ...
                <div class="metric-box-trend" style="color:{clr}">{sub}</div>
            </div>
            """, unsafe_allow_html=True)
